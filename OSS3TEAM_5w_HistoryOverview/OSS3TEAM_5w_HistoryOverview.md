# <img src="https://user-images.githubusercontent.com/114343532/193459496-50b0e084-403a-4395-8faa-318cd852fc97.png" width ="4%" height = "4%"> OSS 개요
...
#### 특징 10가지
<details>
        <summary>1.자유로운 재배포</summary>
        <ul>
           - 오픈 소스를 이용해 제작한 소프트웨어는 자유로운 배포를 허용하고 비용을 받지 않아야 함.<br>(개발자 사기 증진과 장기적인 이익 기대)
        </ul>
      </details>
      
<details>
        <summary>2. 원시 코드</summary>
        <ul>
            - 오픈 소스는 최대한 이용하기 쉽게 작성되어야 한다.<br>(원시코드는 알아보기 쉽고 최소의 비용으로 구할 수 있어야 함)
        </ul>
</details>
<details>
        <summary>3. 파생 저작물</summary>
        <ul>
            - 개작과 파생 저작물을 허용하고 이러한 저작물에도 라이선스를 적용할 수 있도록 해야 한다.
        </ul>
</details>
<details>
        <summary>4. 저작자의 원시코드 원형 유지</summary>
        <ul>
            - 변경된 원시 코드의 배포는 제한 가능하지만 원시 코드를 통해 만들어진 결과물의 배포는 허용해야 한다.<br>(원작자와 수정인의 정보를 나눔으로써 사용자가 피드백이 필요한 부분에 대한 의견을 누구에게 문의할지 명확하게 해 준다.)
        </ul>
</details>
<details>
        <summary>5. 개인이자 단체에 대한 차별 금지</summary>
        <ul>
            - 개인 또는 단체 모두 오픈 소스의 개발과 발전에 큰 보템이 될 수 있으므로 그 누구도 차별하지 않고 오픈소를 이용할 수 있어야 한다.
        </ul>
</details>
<details>
        <summary>6. 사용분야에 대한 차별 금지</summary>
        <ul>
            - 라이선스는 소프트웨어가 특정 분야에서 사용되는 것을 금지해서는 안된다. 상업적 영역이라도 오픈 소스가 사용될 수 있도록 해야 한다.
        </ul>
</details>
<details>
        <summary>7. 라이선스의 배포</summary>
        <ul>
            - 프로그램에 첨부도니 권리는 별도의 라이선스를 적용하지 않고 재배포를 하는 프로그램의 이용자에게도 동일하게 적용되어야 한다.<br>(비공개 동의를 요구하는 등 간접적인 방법으로 소프트웨어를 제한하는 것을 방지)
        </ul>
</details>
<details>
        <summary>8. 특정 제품에만 유효한 사용 허가의 금지</summary>
        <ul>
            프로그램에 첨부된 권리는 특정한 소프트웨어의 배포에 일부분일 경우, 한정적이어서는 안됨. 만약 배포된 프로그램의 라이선스 내에서 추출, 이용, 배포되더라도 재배포 받은 이용자의 원본 프로그램의 라이선스와 같은 권리를 가진다.
        </ul>
</details>
<details>
        <summary>9. 다른 소프트웨어에 대한 제한 금지</summary>
        <ul>
            - 오픈 소스 소프트웨어의 배포자는 자신들의 교유한 소프트웨어 선택권이 있기 때문에 함께 배포되는 모든 소프트웨어가 오픈 소스 라이선스여야만 한다고 강제할 수 없다.
        </ul>
</details>
<details>
        <summary>10. 라이선스는 기술 중립적이어야 한다.</summary>
        <ul>
...
* GNU 프로젝트: 유닉스(Unix)의 상업적 확산에 반발하여 리처드 스톨먼과 그의 팀이 무료로 개발·배포하고 있는 유닉스 호환 운영 체제이며 동시에 그러한 정보 공유 프로젝트 그 자체.
  ...
  <details>
    <summary>출처:저작권 기술 용어사전</summary>
	    <div markdouw="1">
      https://terms.naver.com/entry.naver?docId=18491&cid=43659&categoryId=43659
	    </div>
   </details>
...
* GNU GPL(일반공중허가서): 이 허가를 가진 프로그램을 사용하여 새로운 프로그램을 만들게 되면 파생된 프로그램 역시 같은 카피레프트를 가져야 하는 의무 조항을 포함하고 있다.
  ...
  <details>
	  <summary>출처:저작권 기술 용어사전</summary>
	  <div markdouw="1">
  https://terms.naver.com/entry.naver?docId=2075813&cid=42386&categoryId=42386
	  </div>
  </details>
...
* 카피레프트(= 자유 소프트웨어, ↔ copyright): 지적재산권에 반대해 지적 창작물에 대한 권리를 모든 사람이 공유할 수 있도록 하는 것 또는 그러한 운동. 
  <details>
	  <summary>출처:두산백과</summary>
	  <div markdouw="1">
  https://terms.naver.com/entry.naver?docId=1221893&cid=40942&categoryId=31721/
	  </div>
  </details>
...
- 위와 같은 역사를 거쳐 이제 오픈소스 소프트웨어는 소프트웨어의 한 축을 잡게 됐다.
  ...
  <details>
	  <summary>출처: 오픈소스 소프트웨어의 역사</summary>
	  <div markdouw="1">
...
<img src ="https://user-images.githubusercontent.com/105197524/193438338-c7ff99b2-d9f9-4d72-aaa8-4e8eac531eb3.PNG" width="50%"  height= "200"><img src ="https://user-images.githubusercontent.com/105197524/193438339-fb5e19f1-cb8b-4b90-9a14-fca132ffad49.PNG" width="50%" height= "200">
